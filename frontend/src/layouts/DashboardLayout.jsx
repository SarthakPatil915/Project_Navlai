...
const sidebarLinks = [
  ...
  { to: '/dashboard/events', icon: Calendar, label: 'Browse Events' },
  { to: '/dashboard/events/create', icon: CalendarPlus, label: 'Create Event' },
  { to: '/dashboard/my-enrollments', icon: Ticket, label: 'My Enrollments' },
  { to: '/dashboard/my-events', icon: Calendar, label: 'My Events' },
  { to: '/dashboard/scan-qr', icon: QrCode, label: 'Scan Attendance' },
